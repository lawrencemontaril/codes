...
// Features: Easy to encode questions and answers, no additional programming.
// 			 Number of questions are not limited, you can have as many questions as you want.
//			 Answers are revelead immediately after answering.
//			 Look and feel are easily customizable, just change the values of the variables!
...
public class Quiz implements ActionListener
{
	...
	String[] questions = 
	{
		...
		"A programming paradigm where programs are constucted by composing mathematical operations.",
		"Which of the following codes prints the output below?\nrun:\nI can do it!\nBUILD SUCCESSFUL (total time: 0 seconds)",
		"This occurs when the program contains an illegal operation. These are the only errors that are displayed instantly during the program execution.",
		"This occurs when one or more grammatical rules of the programming language being used is violated.",
		"There is no report generated for these types of programming errors, they are the most difficult ones to deal with.",
		"C language was developed to be used in what operating system?",
		"The process during which we review the details of a program with our peers in order to improve the program.",
	};
	...
	String[][] options = 
	{
		...
		{"Functional programming", "Mathematical programming", "Object-oriented programming", "Imperative programming"},
		{"System.out.print.ln(\"I can do it!\");", "System.out.print.ln(\"I can do it!\");", "System.out.println(\"I can do it!\"):", "System.out.print(\"I can do it!\");"},
		{"Logical error", "Typographical error", "Syntax errors", "Runtime error"},
		{"Typographical error", "Logical error", "Syntax error", "Runtime error"},
		{"Logical error", "Typographical error", "Syntax errors", "Runtime error"},
		{"Unix", "Windows", "macOS", "Linux"},
		{"Code Evaluation", "Code Walk-through", "Code Revision", "Code Inspection"},
	};
